...
<header class="fixed top-0 left-0 right-0 z-50 bg-gradient-to-b from-black/50 to-transparent px-4 py-3">
    <div class="flex items-center justify-between">
        ...
        <!-- Live Indicator -->
        <div class="flex items-center space-x-2 bg-red-600 px-3 py-1 rounded-full">
            <div class="w-2 h-2 bg-white rounded-full animate-pulse"></div>
            <span class="text-sm font-medium">LIVE</span>
        </div>
        
        <!-- More Options -->
        <button class="more-btn text-white hover:text-gray-300 transition-colors">
            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<div class="mobile-fullscreen relative bg-black">
    ...
    <div id="videoContainer" class="w-full h-full bg-gray-900 flex items-center justify-center">
        <div class="text-center">
            ...
            <p class="text-white text-lg font-medium">Connecting to stream...</p>
...
<!-- Stream Ended Modal -->
<div id="streamEndedModal" class="fixed inset-0 bg-black/50 hidden z-50">
    <div class="flex items-center justify-center min-h-screen p-4">
        <div class="bg-gray-800 rounded-lg p-6 w-full max-w-md text-center">
            ...
            <h3 class="text-lg font-semibold font-poppins text-white mb-2">Stream Ended</h3>
            <p class="text-gray-300 font-poppins mb-6">The broadcaster has ended their live stream.</p>
